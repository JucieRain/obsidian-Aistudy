...
备注：本篇内容的中，类似上面这种配图，也是用文档中提到的方法论制作。生成这种配图，可以使用 [李继刚老师的skills](https://github.com/lijigang/ljg-skills/tree/master/skills/ljg-card) ：
...
title: 用 LLM 构建个人知识库
source\_type: x | article | gist | podcast | note | conversation
source\_url: https://example.com
author: Andrej Karpathy
published\_at: 2026-04-02
captured\_at: 2026-04-09
content\_type: post | thread | article | transcript | note
status: complete | partial | shell\_only
tags:
  - llm
  - knowledge-base
attachments:
...
source\_id: 2026-04-09-karpathy-llm-kb-001
title: LLM 知识库工作流摘要
created\_at: 2026-04-09
type: summary
topics:
  - knowledge-system
  - llm-workflow
