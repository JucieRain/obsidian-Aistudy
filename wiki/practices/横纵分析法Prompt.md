...
> 数字生命卡兹克开源的深度研究Prompt，半小时产出万字研究报告

## 使用方法

1. 将下方Prompt复制到支持Deep Research的模型
2. 修改开头「研究对象」一行
3. 等待10-15分钟产出报告
...
hv-analysis Skill（功能更强）：
- 自动联网搜索信息
- 包含arxiv API，查论文
- 生成排版好的PDF报告
- 文风更易读

安装地址：https://github.com/KKKKhazix/khazix-skills
...
- 约1万字报告
- 纵向：历史清晰，关键节点完整
- 横向：对比Prompt/Context/Agent Engineering，专业准确

## 使用建议

1. **拿到报告后**：快速通读建立框架，对疑问点再深挖
2. **模型选择**：推荐Deep Research功能（10分钟以上），普通联网搜索效果打折
3. **正确定位**：报告是研究起点，不是最终结论
